...
export const BudgetDetailComponent = () => {
  ...
  const {
    ...
    enabled: !!id,
    staleTime: 10 * 1000, // Add explicit staleTime since Next.js 15 doesn't cache by default
  })
  ...
  const {
    ...
    enabled: !!id,
    staleTime: 10 * 1000, // Add explicit staleTime
  })
  ...
  const budgetSummary = budget && budgetItems ? calculateBudgetSummary(budget.totalAmount, budgetItems) : null
      ...
      <div className="min-h-screen flex flex-col">
        <main className="flex-1 pt-5 px-4 pb-8 flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <Button onClick={() => router.push("/budgets")}>Return to Budgets</Button>
          </div>
        </main>
      </div>
    )
          ...
          <div className="container max-w-5xl mx-auto">
            ...
            <header className="mb-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  {budget.description && <p className="text-gray-600 dark:text-gray-400 mt-1">{budget.description}</p>}
                  <div className="mt-2 flex flex-col sm:flex-row gap-x-6 gap-y-1 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {budget.categoryId && <span>Category: {categoryQuery.data?.name || "Uncategorized"}</span>}
                  </div>
                </div>

                <div className="flex flex-col sm:flex-row gap-2">
                  <Button variant="outline" className="rounded-full" onClick={handleEditBudget}>
                  ...
                  <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently delete the &ldquo;{budget.name}&ldquo; budget and all of its items. This
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                ...
                <Button variant="outline" size="sm" className="rounded-full" onClick={handleAddItem}>
